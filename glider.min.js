...
!(function (e) {
    ...
    return (
        (t.init = function (e, t) {
            ...
            (t = t || l),
                ('auto' !== o.opt.slidesToShow &&
                    void 0 === o.opt._autoSlide) ||
                    ...
                    (n.opt.rewind ||
                        ...
                        n.arrows.next &&
                            (n.arrows.next.classList.toggle(
                                'disabled',
                                Math.ceil(
                                    n.ele.scrollLeft + n.containerWidth
                ...
                [].forEach.call(n.slides, function (e, t) {
                    var i = e.classList,
                        ...
                        r =
                            ...
                            Math.ceil(r) >= Math.floor(o) &&
                                Math.floor(l) <= Math.ceil(s));
                    i.toggle('visible', r),
                        r !== e &&
                            n.emit('slide-' + (r ? 'visible' : 'hidden'), {
                                slide: t,
                            });
                }),
                n.dots &&
                ...
                e &&
                    ...
                    (n.scrollLock = setTimeout(function () {
                        clearTimeout(n.scrollLock),
                            0.02 <
                                Math.abs(
                                    n.ele.scrollLeft / n.itemWidth - n.slide
                                ) &&
                                (n.mouseDown ||
                                    (n.trackWidth >
                                        n.containerWidth + n.ele.scrollLeft &&
        ...
        (t.scrollItem = function (e, t, i) {
            ...
            var o,
                ...
                l =
                    !0 === t
                        ? (e = Math.round(
                              (e * s.containerWidth) / s.itemWidth
                          )) * s.itemWidth
                        : ('string' == typeof e &&
                              ((l = 'prev' === e),
                              (e =
                                  s.opt.slidesToScroll % 1 ||
                                  s.opt.slidesToShow % 1
                                      ? s.getCurrentSlide()
                                      : s.slide),
                              l
                                  ? (e -= s.opt.slidesToScroll)
                                  : (e += s.opt.slidesToScroll),
                              s.opt.rewind &&
                                  ((o = s.ele.scrollLeft),
                                  (e =
